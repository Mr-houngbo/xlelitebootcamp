  ...
  if (submitSuccess) {
    return (
      ...
      >
        ...
        {/* Bouton WhatsApp — Rejoindre le groupe */}
        <div className="mb-4 relative">
          {/* Pulsating ring effect */}
          <span className="absolute inset-0 rounded-2xl animate-ping bg-[#25D366]/20 pointer-events-none" />
          <a
            href="https://chat.whatsapp.com/JMJYrYWgXTX8ahD6SjfERo?mlu=4&s=cl&p=a"
            target="_blank"
            rel="noopener noreferrer"
            className="relative flex items-center justify-center gap-3 w-full py-5 px-6 rounded-2xl font-bold text-lg text-white shadow-lg shadow-[#25D366]/30 transition-all duration-300 hover:scale-[1.02] hover:shadow-xl hover:shadow-[#25D366]/40 active:scale-[0.98]"
        ...
        <p className="text-xs text-gray-400 mb-6 font-medium">
          📌 Rejoignez dès maintenant pour recevoir toutes les informations et rester en contact avec le groupe.
        </p>
